...
export const informacionSlice = createSlice({
  ...
  reducers: {
    ...
    setCoordenadas: (
      state,
      action: PayloadAction<{ latitud: string; longitud: string }>
    ) => {
    ...
    setHoraFecha: (
      state,
      action: PayloadAction<{ hora: string; fecha: string }>
    ) => {
    ...
    setDispostivoNavegador: (
      state,
      action: PayloadAction<{ dispositivo: string; navegador: string }>
    ) => {
    ...
    setFotos: (
      state,
      action: PayloadAction<{ labelFoto: string; data: string }>
    ) => {
    ...
    setTipoDocumento: (
      state,
      action: PayloadAction<{ tipoDocumento: string }>
    ) => {
      const { tipoDocumento } = action.payload;
